...
.paymentWrap .paymentBtnGroup .paymentMethod .method.vishwa {
  background-image: url("https://i0.wp.com/tech-ish.com/wp-content/uploads/2020/04/Telkom-Kenya-Tkash.jpg?fit=1280%2C720&ssl=1");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.ez-cash {
  background-image: url("https://i0.wp.com/kenyayote.com/wp-content/uploads/2017/12/M-PESA.jpg?fit=600%2C246&ssl=1");
}
...
<div class="container">
    ...
    <div class="row" style="background-color: #f1f1f1a8;">
    ...
    <div class="row">
        ...
        <div class="paymentCont">
                        ...
                        <div class="paymentWrap">
                            <h4 class=""><b>Choose Payment Option</b></h4>
                            <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <p style="background-color: #f1f1f1a8;"><i class="fa fa-info-circle"></i> 100% secure payments processed by swype and secured by verisign ssl. In order to protect you r card from unauthorised use, swype may request furthwe proof of card ownership.</p>
                           
                        </div>
                        <div class="col-sm-12">
                        <div class="alert alert-info">
                                                <strong>Swype Pay will charge KES 65,000 to your Visa Card. SwypePay does not store your card details.</strong>
                                            </div>
                                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="row">
                                <div class="col-lg-12">
                            <form class="form-horizontal m-t-20" action="" autocomplete="OFF">
                        <div class="row">
                        <div class="form-group col-lg-6">
                            <label>CARD NUMBER</label>
                            <div class="col-xs-12">
                                <input class="form-control" style="text-transform: uppercase;" type="number" required="" placeholder="Valid Card Number">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" type="number" required="" placeholder="CVV">
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" style="text-transform: uppercase;" type="number" required="" placeholder="YY">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" type="number" required="" placeholder="MM">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <div class="col-xs-12">
                                <input class="form-control" type="EMAIL" required="" placeholder="Email Address (Registered With Card)">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group text-center m-t-30 col-lg-7">
                            <div class="col-xs-12">
                                <button class="btn btn-round btn-block btn-info waves-effect waves-light" type="submit">Complete Payment</button>
                            </div>
                        </div>
                    </div>
